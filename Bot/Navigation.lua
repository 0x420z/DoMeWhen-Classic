            ...
            if #HotSpots > 0 then
                for i = 1, #HotSpots do
                    if HotSpots[i] then
                        ...
                        -- Draw max roam distance circle
                        LibDraw.SetColor(76, 0, 153, 30)
                        if DMW.Settings.profile.Grind.drawMaxCircles then LibDraw.GroundCircle(x, y, z, DMW.Settings.profile.Grind.RoamDistance*1.5 / 2) end
                    end
                end
            end
        end
